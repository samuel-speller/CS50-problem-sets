...
unsigned int hash(const char *word)
{
    ...
    //currently just sorts according to first letter, toupper is used to make the hash function case insensitive
